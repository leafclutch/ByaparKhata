...
import type { StockStatus, TransactionType, CompanyStatus, SubscriptionStatus, PlanType } from "@/lib/types";
...
const variantStyles: Record<BadgeVariant, string> = {
  ...
  expired: "bg-slate-100 text-slate-600 ring-1 ring-slate-300",
  // Subscription status
  trial: "bg-cyan-50 text-cyan-700 ring-1 ring-cyan-200",
  // Plans
